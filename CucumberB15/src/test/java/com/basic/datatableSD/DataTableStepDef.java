...
public class DataTableStepDef {
	...
	@When("^user clear username$")
	public void user_clear_username() throws InterruptedException{
	...
	*/
	...
	public void enter_followind_data(DataTable table) throws InterruptedException{
		...
		driver.findElement(By.name("firstname")).sendKeys(values3);
		driver.findElement(By.name("lastname")).sendKeys(values4);
		
		driver.findElement(By.name("firstname")).sendKeys(values5);
		driver.findElement(By.name("lastname")).sendKeys(values6);
		Thread.sleep(2000);
